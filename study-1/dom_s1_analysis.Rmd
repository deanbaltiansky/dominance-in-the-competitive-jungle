...
m1 <- lm(self_dominance ~ CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num,data = df_s1_elg)
...
```{r,echo=FALSE,results='asis',warning=FALSE,message=F,fig.align='left'}
m1 <- lm(rel_dominance ~ CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num,data = df_s1_elg)
...
<a href="./mediation-app/index.html" target="_blank" rel="noopener"
     style="background:#0b69ff;color:white;padding:0.55em 0.9em;border-radius:8px;text-decoration:none;">
...
med.fit <- lm(rel_dominance ~ CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num,
              data = df_s1_elg)

# Step 2: Fit the outcome model
out.fit <- lm(self_dominance ~ CWV + rel_dominance + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num,
              data = df_s1_elg)

# Step 3: Conduct the mediation analysis
med.out <- mediation::mediate(med.fit, out.fit,
                   treat = "CWV",
                   mediator = "rel_dominance",
...
model <- '
  ...
  rel_dominance  ~ a1 * CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num
  infl_dominance ~ a2 * CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num

  # Regression for outcome
  self_dominance ~ b1 * rel_dominance + b2 * infl_dominance + c_prime * CWV + ZSB + copri + rel_care + TOPS_coer + TOPS_coll + age + white + man + edu_num + income_num
...
fit <- sem(model, data = df_s1_elg, se = "bootstrap", bootstrap = 10000)
