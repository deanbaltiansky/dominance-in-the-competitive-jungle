...
# ---- Data loaders ----
load_data <- function() {
  p <- "data/df_s1_elg.csv"
  if (!file.exists(p)) stop("Missing data/df_s1_elg.csv in study-1/app/lm-table-app/data/")
...
ui <- fluidPage(
  titlePanel("Dominance Through the Lens of a Competitive Worldview — Linear Model Table"),
  sidebarLayout(
    sidebarPanel(
